...
import { SelectedAsset, GradientPreset, EXPORT_DIMENSIONS, ExportFormat } from "@/lib/types";
...
export default function CardPreview({
  ...
  }, [updateScale, format]); // Reexecuta ao mudar formato
  ...
  return (
    <section>
      ...
      <div
        ref={containerRef}
        className="relative bg-white/[0.02] border border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300"
      ...
      >
        ...
        <span className="absolute top-3 right-3 z-10 text-xs text-zinc-500 bg-zinc-900/80 px-2 py-0.5 rounded select-none">
          Visualização ({format === "horizontal" ? "Horizontal" : "Vertical"})
        </span>
